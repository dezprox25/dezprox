  ...
  return (
    <section className="py-16 px-4 bg-[#f3fcf3]">
      <div className="max-w-6xl mx-auto text-center">
        {/* Heading */}
        <h3 className="bg-gradient-to-b from-green-800  to-green-500 bg-clip-text text-transparent text-xl font-medium mb-4">How We Stand Out</h3>
        
        {/* <h2 className="text-4xl md:text-5xl font-bold mb-6">What Makes Us Different?</h2> */}
        <TextGenerateEffect  className="text-4xl md:text-5xl font-semibold mb-6" words="What Makes Us Different?"/>
