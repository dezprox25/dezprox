      ...
      <div className="container mx-auto " data-aos="fade-right">
        <div className="flex flex-col md:flex-row items-start gap-8">
          ...
          <div className="w-full md:w-1/2">
            ...
            {/* Service Title */}
            <h3 className="text-3xl font-bold mb-6">Grow, Optimize, Reach More</h3>

            {/* Service Description */}
            <p className="text-gray-700 mb-6">
              Increase your online presence and reach the right people with our effective marketing strategies. We help grow your business by driving traffic and engagement successfully.
            </p>
          ...
          {/* Right Content - Placeholder Image */}
          <div className="w-full md:w-1/2 mt-8 md:mt-0">
            <div className=" rounded-lg h-full min-h-[400px]"><Image width={500} height={500} src="https://res.cloudinary.com/dwcvkrrpz/image/upload/v1744105164/Marketing_ocyjvu.png" alt="" /></div>
          </div>
        </div>
      </div>
    </section>
